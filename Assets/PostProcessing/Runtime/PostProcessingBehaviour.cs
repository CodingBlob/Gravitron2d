...
namespace UnityEngine.PostProcessing
{
    ...
    public class PostProcessingBehaviour : MonoBehaviour
    {
        ...
        void OnPreCull()
        {
            // All the per-frame initialization logic has to be done in OnPreCull instead of UpdateParams
            // because [ImageEffectAllowedInSceneView] doesn't trigger UpdateParams events...
